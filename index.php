...
<div id='gora'>
        ...
        <div id='panelPrawa'>
             ...
             <div class='text-gora zaloguj'><i class='fas fa-sign-in-alt'></i><br><div class='small-text'>Zaloguj się</div></div>

             <div class='text-gora zarejestruj'><i class='fas fa-plus'></i><br><div class='small-text'>Zarejestruj się</div></div>

             <div class='text-gora pomoc'><i class='fas fa-question'></i><br><div class='small-text'>Pomoc</div></div>

             <div class='text-gora faq'><i class='fas fa-info'></i><br><div class='small-text'>FAQ</div></div>
             <script>
        ...
        <div id='panelPrawaMobile'>
            ...
            <a href='?page=panel'><div class='text-gora font'><i class='fas fa-bars'></i></div></a>
...
<!--koniec ukrytych elementów-->
    ...
    <div id="leweOkno">
        ...
        <div class="just font-regular font-center">
            ...
            <span style="color: white;">Chcesz zostać <span style="color: red;">hackerem</span> bez ponoszenia konsekwencji w życiu? Chcesz się bawić i zostać najlepszym z najlepszych lecz w dodatku niewykrywalnym? Zapraszam Cię tu do naszej społeczności! Tylko u nas znajdziesz taką rozgrywkę! <br><br> Podnoś się na naszej arenie hakerów i pokaż kto tu jest anonimowy!<br> Załóż kontku juz dzisiaj nie zwlekaj z tą decyzją!</span>
